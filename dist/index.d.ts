 ...
 */
declare function easyWaf(conf?: EasyWaf.Config): (rawReq: IncomingMessage$1 & {
    body?: unknown;
    query?: unknown;
}, res: EasyWaf.Response, next: () => void) => Promise<void>;

export { EasyWaf, easyWaf as default };
